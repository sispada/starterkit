...
class PlatformMakeExport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'module:make-export
        {name}
        {--module=}
    ';
     ...
     * @var string
     */
    protected $description = 'Make monosoft new export in module';
    ...
    public function handle()
    {
        ...
        /** SET STUB FILE */
        $stubFile = __DIR__ . DIRECTORY_SEPARATOR . 'system-stubs' . DIRECTORY_SEPARATOR . 'export.stub';
        ...
        if ($fileSystem->exists($fileOutput)) {
            $this->error('The export already exists.');
            return;
        }
