...
class PlatformMakeSeed extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Make monosoft new seeder in module';
    ...
    public function handle()
    {
        ...
        /** SET STUB FILE */
        $stubFile = __DIR__ . DIRECTORY_SEPARATOR . 'system-stubs' . DIRECTORY_SEPARATOR . 'seeder.stub';
