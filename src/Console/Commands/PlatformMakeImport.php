...
class PlatformMakeImport extends Command
{
    /**
     ...
     * @var string
     */
    protected $signature = 'module:make-import
        {name}
        {--model=}
        {--module=}
    ';
     ...
     * @var string
     */
    protected $description = 'Make monosoft new import in module';
    ...
    public function handle()
    {
        ...
        /** SET STUB FILE */
        $stubFile = __DIR__ . DIRECTORY_SEPARATOR . 'system-stubs' . DIRECTORY_SEPARATOR . 'import.stub';
    ...
    protected function getStubContents($module, $stubFile): string
    {
        ...
        $replacements = [
            ...
            str($this->option('model'))->studly()->snake()->plural()->lower()->toString(),
