...
class PlatformMakeEvent extends Command
{
    /**
     ...
     * @var string
     */
    protected $description = 'Make monosoft new event in module';
    ...
    public function handle()
    {
        ...
        /** SET STUB FILE */
        $stubFile = __DIR__ . DIRECTORY_SEPARATOR . 'system-stubs' . DIRECTORY_SEPARATOR . 'event.stub';
